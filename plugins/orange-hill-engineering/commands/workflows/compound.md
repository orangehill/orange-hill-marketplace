...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - Any code-heavy issue → `architecture-strategist` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ architecture-strategist: Code examples meet architectural standards
  ✓ code-simplicity-reviewer: Solution is appropriately minimal
  ✓ orange-hill-style-editor: Documentation style verified
...
- **code-simplicity-reviewer**: Reviews solution for unnecessary complexity
- **data-integrity-guardian**: Reviews database_issue migrations and queries

### Enhancement & Documentation
- **best-practices-researcher**: Enriches solution with industry best practices
- **orange-hill-style-editor**: Reviews documentation style and clarity
