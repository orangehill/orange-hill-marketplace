...
2. **Identify Relevant Skills**:
   ...
   - Laravel/PHP → framework-docs-researcher with Context7 MCP
   - Frontend/Design → `frontend-design`
   - TypeScript/React/Next.js → framework-docs-researcher with Context7 MCP
   - Documentation → `compound-docs`, `orange-hill-style-editor`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: compound-docs" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The compound-docs skill recommends..." (highest authority - curated)
